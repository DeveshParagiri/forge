//! Exaforge welcome-screen branding and announcement policy.
//!
//! Keep the fork-specific policy in this leaf module so upstream welcome
//! layout changes can be rebased without repeatedly editing their structure.

pub(crate) const PRODUCT_NAME: &str = "Exaforge";
pub(crate) const SUBTITLE: Option<&str> = None;
...
pub(crate) fn changelog_bullets(value: &[String]) -> &[String] {
