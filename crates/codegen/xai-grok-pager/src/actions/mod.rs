...
pub(crate) fn default_actions(
    ...
    let mut actions = defaults::default_actions(screen_mode, mouse_reporting_toggle_enabled);
...
impl ActionRegistry {
    ...
    /// Create the default fullscreen registry with all standard and Forge actions.
    pub fn defaults() -> Self {
        Self::defaults_for(crate::app::ScreenMode::Fullscreen)
    }

    /// Create the composed registry for the process-lifetime screen mode.
    pub(crate) fn defaults_for(screen_mode: crate::app::ScreenMode) -> Self {
        Self::defaults_with_config_for(screen_mode, false)
    }

    /// Create the default fullscreen registry, optionally including
    ...
    /// Create the composed registry for a screen mode, optionally including
    /// config-gated actions.
    pub(crate) fn defaults_with_config_for(
        screen_mode: crate::app::ScreenMode,
        mouse_reporting_toggle_enabled: bool,
    ) -> Self {
        Self::new(Self::composed_actions(
            screen_mode,
            mouse_reporting_toggle_enabled,
        ))
    }
    ...
    pub(crate) fn non_vscode_for_mode_for_test(screen_mode: crate::app::ScreenMode) -> Self {
        use crate::key;
        let mut actions = Self::composed_actions(screen_mode, false);
