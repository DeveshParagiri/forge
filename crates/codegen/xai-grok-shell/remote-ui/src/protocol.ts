...
const USAGE_STATUSES = new Set<RemoteUsageStatus>([
  "idle",
  "loading",
  "ready",
  "partial",
...
function decodeUsage(value: unknown): RemoteUsageSnapshot {
  ...
  const usage: RemoteUsageSnapshot = {
    ...
    ...(optionalString(value, "refreshedAt") ? { refreshedAt: optionalString(value, "refreshedAt") } : {}),
  };
  ...
  if (value.session !== undefined && value.session !== null) {
    ...
    let models: RemoteUsageModel[] | undefined;
    if (value.session.models !== undefined && value.session.models !== null) {
      if (!Array.isArray(value.session.models)) {
  ...
  if (value.account !== undefined && value.account !== null) {
    ...
    usage.account = {
      ...
      ...(optionalString(value.account, "plan") ? { plan: optionalString(value.account, "plan") } : {}),
  ...
  if (value.errors !== undefined && value.errors !== null) {
    ...
    usage.errors = {
      ...(optionalString(value.errors, "context") ? { context: optionalString(value.errors, "context") } : {}),
      ...(optionalString(value.errors, "session") ? { session: optionalString(value.errors, "session") } : {}),
      ...(optionalString(value.errors, "account") ? { account: optionalString(value.errors, "account") } : {}),
    };
  }
  return usage;
}
...
function timelineBase(record: Record<string, unknown>) {
  return {
    ...
    ...(optionalString(record, "createdAt") ? { createdAt: optionalString(record, "createdAt") } : {}),
  };
}
...
function decodeSnapshot(value: unknown): RemoteSessionSnapshot {
  ...
  if (value.planMode !== undefined && value.planMode !== null) {
    ...
    snapshot.planMode = {
      ...
      ...(optionalString(value.planMode, "plan") ? { plan: optionalString(value.planMode, "plan") } : {}),
    };
  }
  ...
  if (value.taskState !== undefined && value.taskState !== null) {
    ...
    snapshot.taskState = {
      ...(optionalString(value.taskState, "label") ? { label: optionalString(value.taskState, "label") } : {}),
