...
export interface PendingApproval {
  ...
  /** Exact Forge Remote actions; absent for the upstream T3 controller path. */
  readonly remoteActions?: ReadonlyArray<PendingApprovalRemoteAction>;
  /** Optional text response kept separate so arbitrary gateway options stay exact. */
  readonly remoteFeedback?: PendingApprovalRemoteFeedback;
}

export interface PendingApprovalRemoteAction {
  readonly id: string;
...
export interface PendingApprovalRemoteFeedback {
