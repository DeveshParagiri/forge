...
export function threadSettingsSummaryLabel(input: {
  ...
  return [
    ...
    ...(runtime && input.includeRuntime !== false ? [runtime.shortLabel] : []),
                  ...
                  {collapsed
                    ...
                    : visibleModels.map((option) => (
                        <ModelRow
                          ...
                          disabled={props.modelSelectionDisabled}
                          onPress={() => {
                            void Haptics.selectionAsync();
              ...
              if ((live?.type ?? entry.type) === "select") {
                return (
                  <DisclosureRow
                    ...
                    disabled={!live || props.modelSelectionDisabled}
                    onPress={() => {
                      if (live) {
