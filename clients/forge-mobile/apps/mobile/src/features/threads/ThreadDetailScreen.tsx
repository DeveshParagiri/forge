...
export interface ThreadDetailScreenProps {
  ...
  readonly remoteRespondingApprovalIds?: ReadonlyArray<ApprovalRequestId>;
  ...
  readonly onRespondToRemoteApproval?: (
    requestId: ApprovalRequestId,
    actionId: string,
    feedback?: string,
  ) => Promise<unknown>;
  ...
  /** Forge Remote keeps T3 chat chrome while hiding unsupported controls. */
...
export const ThreadDetailScreen = memo(function ThreadDetailScreen(props: ThreadDetailScreenProps) {
  const visiblePendingApprovals =
    props.remotePendingApprovals ??
    (props.activePendingApproval ? [props.activePendingApproval] : []);
        ...
        >
          ...
          <View ref={composerOverlayRef} onLayout={onComposerLayout} className="w-full">
            ...
            <View className="w-full self-center" style={{ maxWidth: contentMaxWidth }}>
              {visiblePendingApprovals.length > 0 || props.activePendingUserInput ? (
                <Animated.View
                  ...
                  {visiblePendingApprovals.map((approval) => (
                    <PendingApprovalCard
                      ...
                      respondingApprovalId={
                        props.remoteRespondingApprovalIds?.includes(approval.requestId)
                          ? approval.requestId
                          : props.respondingApprovalId
                      }
                      onRespond={props.onRespondToApproval}
                      onRemoteRespond={props.onRespondToRemoteApproval}
                    />
                  ))}
